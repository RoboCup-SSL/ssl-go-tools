...
func (*SSL_DetectionBall) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*SSL_DetectionRobot) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*SSL_DetectionFrame) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func init() { proto.RegisterFile("messages_robocup_ssl_detection.proto", fileDescriptor0) }
