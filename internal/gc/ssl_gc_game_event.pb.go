...
const file_gc_ssl_gc_game_event_proto_rawDesc = "" +
	...
	"\x1aball_left_field_touch_line\x18\x06 \x01(\v2\x18.GameEvent.BallLeftFieldH\x00R\x16ballLeftFieldTouchLine\x12T\n" +
	"\x19ball_left_field_goal_line\x18\a \x01(\v2\x18.GameEvent.BallLeftFieldH\x00R\x15ballLeftFieldGoalLine\x12;\n" +
	"\faimless_kick\x18\v \x01(\v2\x16.GameEvent.AimlessKickH\x00R\vaimlessKick\x12u\n" +
	"\"attacker_too_close_to_defense_area\x18\x13 \x01(\v2(.GameEvent.AttackerTooCloseToDefenseAreaH\x00R\x1dattackerTooCloseToDefenseArea\x12[\n" +
	"\x18defender_in_defense_area\x18\x1f \x01(\v2 .GameEvent.DefenderInDefenseAreaH\x00R\x15defenderInDefenseArea\x12J\n" +
	"\x11boundary_crossing\x18+ \x01(\v2\x1b.GameEvent.BoundaryCrossingH\x00R\x10boundaryCrossing\x12E\n" +
	"\x10keeper_held_ball\x18\r \x01(\v2\x19.GameEvent.KeeperHeldBallH\x00R\x0ekeeperHeldBall\x12\\\n" +
	...
	"\x0fbot_crash_drawn\x18\x15 \x01(\v2\x18.GameEvent.BotCrashDrawnH\x00R\rbotCrashDrawn\x12o\n" +
	" defender_too_close_to_kick_point\x18\x1d \x01(\v2&.GameEvent.DefenderTooCloseToKickPointH\x00R\x1bdefenderTooCloseToKickPoint\x12M\n" +
	"\x14bot_too_fast_in_stop\x18\x1c \x01(\v2\x1b.GameEvent.BotTooFastInStopH\x00R\x10botTooFastInStop\x12]\n" +
	"\x18bot_interfered_placement\x18\x14 \x01(\v2!.GameEvent.BotInterferedPlacementH\x00R\x16botInterferedPlacement\x126\n" +
	"\rpossible_goal\x18' \x01(\v2\x0f.GameEvent.GoalH\x00R\fpossibleGoal\x12%\n" +
	"\x04goal\x18\b \x01(\v2\x0f.GameEvent.GoalH\x00R\x04goal\x124\n" +
	"\finvalid_goal\x18, \x01(\v2\x0f.GameEvent.GoalH\x00R\vinvalidGoal\x12g\n" +
	"\x1cattacker_double_touched_ball\x18\x0e \x01(\v2$.GameEvent.AttackerDoubleTouchedBallH\x00R\x19attackerDoubleTouchedBall\x12P\n" +
	"\x13placement_succeeded\x18\x05 \x01(\v2\x1d.GameEvent.PlacementSucceededH\x00R\x12placementSucceeded\x12N\n" +
	"\x13penalty_kick_failed\x18- \x01(\v2\x1c.GameEvent.PenaltyKickFailedH\x00R\x11penaltyKickFailed\x12L\n" +
	"\x13no_progress_in_game\x18\x02 \x01(\v2\x1b.GameEvent.NoProgressInGameH\x00R\x10noProgressInGame\x12G\n" +
	...
	"\x0eemergency_stop\x18/ \x01(\v2\x18.GameEvent.EmergencyStopH\x00R\remergencyStop\x12`\n" +
	"\x19unsporting_behavior_minor\x18# \x01(\v2\".GameEvent.UnsportingBehaviorMinorH\x00R\x17unsportingBehaviorMinor\x12`\n" +
	"\x19unsporting_behavior_major\x18$ \x01(\v2\".GameEvent.UnsportingBehaviorMajorH\x00R\x17unsportingBehaviorMajor\x125\n" +
	"\bprepared\x18\x01 \x01(\v2\x13.GameEvent.PreparedB\x02\x18\x01H\x00R\bprepared\x12B\n" +
	"\rindirect_goal\x18\t \x01(\v2\x17.GameEvent.IndirectGoalB\x02\x18\x01H\x00R\findirectGoal\x12?\n" +
	"\fchipped_goal\x18\n" +
	" \x01(\v2\x16.GameEvent.ChippedGoalB\x02\x18\x01H\x00R\vchippedGoal\x12?\n" +
	"\fkick_timeout\x18\f \x01(\v2\x16.GameEvent.KickTimeoutB\x02\x18\x01H\x00R\vkickTimeout\x12\x8e\x01\n" +
	")attacker_touched_opponent_in_defense_area\x18\x10 \x01(\v2/.GameEvent.AttackerTouchedOpponentInDefenseAreaB\x02\x18\x01H\x00R$attackerTouchedOpponentInDefenseArea\x12\x9d\x01\n" +
	"1attacker_touched_opponent_in_defense_area_skipped\x18* \x01(\v2/.GameEvent.AttackerTouchedOpponentInDefenseAreaB\x02\x18\x01H\x00R+attackerTouchedOpponentInDefenseAreaSkipped\x12X\n" +
	"\x18bot_crash_unique_skipped\x18\x17 \x01(\v2\x19.GameEvent.BotCrashUniqueB\x02\x18\x01H\x00R\x15botCrashUniqueSkipped\x12R\n" +
	"\x16bot_pushed_bot_skipped\x18\x19 \x01(\v2\x17.GameEvent.BotPushedBotB\x02\x18\x01H\x00R\x13botPushedBotSkipped\x12{\n" +
	"\"defender_in_defense_area_partially\x18\x1e \x01(\v2).GameEvent.DefenderInDefenseAreaPartiallyB\x02\x18\x01H\x00R\x1edefenderInDefenseAreaPartially\x12j\n" +
	"\x1bmultiple_placement_failures\x18! \x01(\v2$.GameEvent.MultiplePlacementFailuresB\x02\x18\x01H\x00R\x19multiplePlacementFailures\x1al\n" +
	"\rBallLeftField\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x1a\x99\x01\n" +
	"\vAimlessKick\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12-\n" +
	"\rkick_location\x18\x04 \x01(\v2\b.Vector2R\fkickLocation\x1a\xe2\x02\n" +
	"\x04Goal\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12(\n" +
	"\fkicking_team\x18\x06 \x01(\x0e2\x05.TeamR\vkickingTeam\x12\x1f\n" +
	"\vkicking_bot\x18\x02 \x01(\rR\n" +
	"kickingBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12-\n" +
	"\rkick_location\x18\x04 \x01(\v2\b.Vector2R\fkickLocation\x12&\n" +
	"\x0fmax_ball_height\x18\x05 \x01(\x02R\rmaxBallHeight\x12+\n" +
	"\x12num_robots_by_team\x18\a \x01(\rR\x0fnumRobotsByTeam\x12+\n" +
	"\x12last_touch_by_team\x18\b \x01(\x04R\x0flastTouchByTeam\x12\x18\n" +
	"\amessage\x18\t \x01(\tR\amessage\x1a\x9a\x01\n" +
	"\fIndirectGoal\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12-\n" +
	"\rkick_location\x18\x04 \x01(\v2\b.Vector2R\fkickLocation\x1a\xc1\x01\n" +
	"\vChippedGoal\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12-\n" +
	"\rkick_location\x18\x04 \x01(\v2\b.Vector2R\fkickLocation\x12&\n" +
	"\x0fmax_ball_height\x18\x05 \x01(\x02R\rmaxBallHeight\x1a\x85\x01\n" +
	"\x10BotTooFastInStop\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x14\n" +
	"\x05speed\x18\x04 \x01(\x02R\x05speed\x1a\x96\x01\n" +
	"\x1bDefenderTooCloseToKickPoint\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bdistance\x18\x04 \x01(\x02R\bdistance\x1a\xd0\x01\n" +
	"\rBotCrashDrawn\x12\x1d\n" +
	"\n" +
	"bot_yellow\x18\x01 \x01(\rR\tbotYellow\x12\x19\n" +
	"\bbot_blue\x18\x02 \x01(\rR\abotBlue\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1f\n" +
	"\vcrash_speed\x18\x04 \x01(\x02R\n" +
	"crashSpeed\x12\x1d\n" +
	"\n" +
	"speed_diff\x18\x05 \x01(\x02R\tspeedDiff\x12\x1f\n" +
	"\vcrash_angle\x18\x06 \x01(\x02R\n" +
	"crashAngle\x1a\xeb\x01\n" +
	"\x0eBotCrashUnique\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x1a\n" +
	"\bviolator\x18\x02 \x01(\rR\bviolator\x12\x16\n" +
	"\x06victim\x18\x03 \x01(\rR\x06victim\x12$\n" +
	"\blocation\x18\x04 \x01(\v2\b.Vector2R\blocation\x12\x1f\n" +
	"\vcrash_speed\x18\x05 \x01(\x02R\n" +
	"crashSpeed\x12\x1d\n" +
	"\n" +
	"speed_diff\x18\x06 \x01(\x02R\tspeedDiff\x12\x1f\n" +
	"\vcrash_angle\x18\a \x01(\x02R\n" +
	"crashAngle\x1a\xb1\x01\n" +
	"\fBotPushedBot\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x1a\n" +
	"\bviolator\x18\x02 \x01(\rR\bviolator\x12\x16\n" +
	"\x06victim\x18\x03 \x01(\rR\x06victim\x12$\n" +
	"\blocation\x18\x04 \x01(\v2\b.Vector2R\blocation\x12'\n" +
	...
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bdistance\x18\x04 \x01(\x02R\bdistance\x1a\xc8\x01\n" +
	"\x1eDefenderInDefenseAreaPartially\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bdistance\x18\x04 \x01(\x02R\bdistance\x12-\n" +
	"\rball_location\x18\x05 \x01(\v2\b.Vector2R\fballLocation\x1a\x9b\x01\n" +
	" AttackerTouchedBallInDefenseArea\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bdistance\x18\x04 \x01(\x02R\bdistance\x1a\xbb\x01\n" +
	"\x14BotKickedBallTooFast\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12,\n" +
	"\x12initial_ball_speed\x18\x04 \x01(\x02R\x10initialBallSpeed\x12\x18\n" +
	"\achipped\x18\x05 \x01(\bR\achipped\x1a\x8a\x01\n" +
	"\x15BotDribbledBallTooFar\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12\x1e\n" +
	"\x05start\x18\x03 \x01(\v2\b.Vector2R\x05start\x12\x1a\n" +
	"\x03end\x18\x04 \x01(\v2\b.Vector2R\x03end\x1a\x9b\x01\n" +
	"$AttackerTouchedOpponentInDefenseArea\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12\x16\n" +
	"\x06victim\x18\x04 \x01(\rR\x06victim\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x1ax\n" +
	"\x19AttackerDoubleTouchedBall\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x1a\xc7\x01\n" +
	"\x1dAttackerTooCloseToDefenseArea\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bdistance\x18\x04 \x01(\x02R\bdistance\x12-\n" +
	"\rball_location\x18\x05 \x01(\v2\b.Vector2R\fballLocation\x1a\x92\x01\n" +
	"\x17BotHeldBallDeliberately\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bduration\x18\x04 \x01(\x02R\bduration\x1au\n" +
	"\x16BotInterferedPlacement\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x15\n" +
	"\x06by_bot\x18\x02 \x01(\rR\x05byBot\x12$\n" +
	"\blocation\x18\x03 \x01(\v2\b.Vector2R\blocation\x1a/\n" +
	"\rMultipleCards\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x1ai\n" +
	"\rMultipleFouls\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x128\n" +
	"\x12caused_game_events\x18\x02 \x03(\v2\n" +
	".GameEventR\x10causedGameEvents\x1a;\n" +
	"\x19MultiplePlacementFailures\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x1ag\n" +
	"\vKickTimeout\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12$\n" +
	"\blocation\x18\x02 \x01(\v2\b.Vector2R\blocation\x12\x12\n" +
	...
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12$\n" +
	"\blocation\x18\x02 \x01(\v2\b.Vector2R\blocation\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\x02R\bduration\x1a\x8d\x01\n" +
	"\x12PlacementSucceeded\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x1d\n" +
	"\n" +
	...
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12\x1a\n" +
	"\baccepted\x18\x02 \x02(\bR\baccepted\x1a/\n" +
	"\rEmergencyStop\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x1a\xbb\x01\n" +
	...
	"\rball_location\x18\x04 \x01(\v2\b.Vector2R\fballLocation\x1aX\n" +
	"\x10BoundaryCrossing\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12$\n" +
	"\blocation\x18\x02 \x01(\v2\b.Vector2R\blocation\x1aq\n" +
	...
	"\x19BALL_LEFT_FIELD_GOAL_LINE\x10\a\x12\x10\n" +
	"\fAIMLESS_KICK\x10\v\x12&\n" +
	...
	"\bPREPARED\x10\x01\x1a\x02\b\x01\x12\x15\n" +
	"\rINDIRECT_GOAL\x10\t\x1a\x02\b\x01\x12\x14\n" +
	"\fCHIPPED_GOAL\x10\n" +
	"\x1a\x02\b\x01\x12\x14\n" +
	"\fKICK_TIMEOUT\x10\f\x1a\x02\b\x01\x121\n" +
	")ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA\x10\x10\x1a\x02\b\x01\x129\n" +
	"1ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA_SKIPPED\x10(\x1a\x02\b\x01\x12 \n" +
	"\x18BOT_CRASH_UNIQUE_SKIPPED\x10\x17\x1a\x02\b\x01\x12\x1e\n" +
	"\x16BOT_PUSHED_BOT_SKIPPED\x10\x19\x1a\x02\b\x01\x12*\n" +
	"\"DEFENDER_IN_DEFENSE_AREA_PARTIALLY\x10\x1e\x1a\x02\b\x01\x12#\n" +
	"\x1bMULTIPLE_PLACEMENT_FAILURES\x10!\x1a\x02\b\x01B\a\n" +
	"\x05eventBHB\x13SslGcGameEventProtoP\x01Z/github.com/RoboCup-SSL/ssl-go-tools/internal/gc"

var (
	file_gc_ssl_gc_game_event_proto_rawDescOnce sync.Once
	file_gc_ssl_gc_game_event_proto_rawDescData []byte
)

func file_gc_ssl_gc_game_event_proto_rawDescGZIP() []byte {
	file_gc_ssl_gc_game_event_proto_rawDescOnce.Do(func() {
		file_gc_ssl_gc_game_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gc_ssl_gc_game_event_proto_rawDesc), len(file_gc_ssl_gc_game_event_proto_rawDesc)))
	})
